...
public class DeepSeekEngine extends AbstractLLMEngine {
    public DeepSeekEngine(String apiKey, String apiEndpoint) {
        super(apiKey, apiEndpoint, Constants.DeepSeek, new ModelInfo(
            "deepseek-coder",
            "1.0",
            "DeepSeek",
            32768,
