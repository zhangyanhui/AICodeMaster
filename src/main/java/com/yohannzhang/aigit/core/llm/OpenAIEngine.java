...
public class OpenAIEngine extends AbstractLLMEngine {
    public OpenAIEngine(String apiKey, String apiEndpoint) {
        super(apiKey, apiEndpoint, Constants.OpenAI_API, new ModelInfo(
            "gpt-4-turbo-preview",
            "1.0",
            "OpenAI",
            32768,
