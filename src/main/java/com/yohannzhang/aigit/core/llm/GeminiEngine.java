...
public class GeminiEngine extends AbstractLLMEngine {
    public GeminiEngine(String apiKey, String apiEndpoint) {
        super(apiKey, apiEndpoint, Constants.Gemini, new ModelInfo(
            "gemini-pro",
            "1.0",
            "Google",
            32768,
