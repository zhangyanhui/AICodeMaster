...
public class SiliconFlowEngine extends AbstractLLMEngine {
    public SiliconFlowEngine(String apiKey, String apiEndpoint) {
        super(apiKey, apiEndpoint, Constants.SiliconFlow, new ModelInfo(
            "silicon-flow-1.0",
            "1.0",
            "SiliconFlow",
            32768,
