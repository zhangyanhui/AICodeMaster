...
public class GenerateUmlDiagramAction extends AnAction {
    private static final String RESULT_BOX_TOOL_WINDOW = "AICodeMaster";
    private final AtomicBoolean isCancelled = new AtomicBoolean(false);
    private AnalysisService analysisService;

    public GenerateUmlDiagramAction() {
        super("UML 图表");
    }
...
//        windowFactory.updateResult("正在准备生成项目文档...\n", project);
        ...
        String docFile = docDir + File.separator + "UML图表_" + timestamp + ".md";

        // 生成项目文档
        AtomicReference<StringBuilder> content = new AtomicReference<>(new StringBuilder());

        String promt = analysisService.generateUmlDiagram(projectFiles);
